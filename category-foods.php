...
<html lang="en">
    <head>
	    ...
	    <title>Secangkir | <?php echo $category_name; ?> Category</title>
    ...
    <body>
        ...
        <div class="tablecontainer">
            <h1>category</h1>
            <p><a href="index.php">Home</a> / <a href="menu.php">Menu</a><span> / Category</span></p>
        </div>
            ...
            <section class="popular">
                <div class="container">
                    <div class="container1">
                        <h2 class="text-center"><?php echo $category_name; ?> Category</h2>
                    </div>
